...
public class MyUtilsTest {
	...
	@Test
	public void longPositive() {
		long expected = 1;
		assertEquals(MyUtils.longRequirePositive(1L, "one"), expected);
	}

    //---------------------------NOVOS TESTES!!!--------------------------------------------
	
    @Test
    public void testOnIntRequirePositive2() { //meu proprio teste
    	int expected = 1;
        assertEquals(MyUtils.intRequirePositive(1, "one"), expected);
    }
    
	@Test
    public void testOnLongRequirePositive2() { //meu proprio teste
		long expected = 1L;
		assertEquals(expected, MyUtils.longRequirePositive(1, "one") );
	}
	
	   
    @Test
    public void testOnLongRequireRange2() { 		//Meu proprio teste
        MyUtils.longRequireRange(Long.MAX_VALUE,
                Long.MAX_VALUE, Long.MAX_VALUE, "exception");
        MyUtils.longRequireRange(Long.MIN_VALUE,
                Long.MIN_VALUE, Long.MIN_VALUE, "exception");
    }
  
   @Test
    public void testOnLongRequireRange3() { //meu proprio teste
	   	long maxValue = 10;
	   	long minValue = 0;
	   	long val = 5;
	   	long expected =5;
	   	assertEquals(expected, MyUtils.longRequireRange(val, minValue, maxValue, "exception"));
    }
}